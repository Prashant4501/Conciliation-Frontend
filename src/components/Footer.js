...
import glogo from "../image/myLogo.png";
      ...
      <div>
        <footer className="text-gray-400 bg-gray-900 body-font">
          <div className="container w-full px-5 py-8 mx-auto flex items-center sm:flex-row flex-col ">
            <a
              href="https://gkrcoder.vercel.app/"
              target="_blank"
              className="flex title-font font-medium items-center hover:cursor-pointer md:justify-start justify-center text-white"
            >
